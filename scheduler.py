...
INIT_BIDS = {
    ...
    # 2026-06-16 2차 틈새 키워드 (증상/고장 계열)
    "에어컨실외기안돌아감": {"ms": 2000, "comp": "낮음", "bid": 300},  # 300원→722회
    "에어컨소음":          {"ms": 1500, "comp": "낮음", "bid": 300},  # 300원→345회
    "실외기소음":          {"ms": 1500, "comp": "낮음", "bid": 300},  # 300원→470회
    "에어컨안켜짐":        {"ms": 2000, "comp": "낮음", "bid": 300},  # 300원→429회
    "에어컨드레인":        {"ms": 1000, "comp": "낮음", "bid": 300},  # 300원→233회
    "에어컨고장":          {"ms": 3000, "comp": "낮음", "bid": 500},  # 500원→216회
    "에어컨가스충전비용":   {"ms": 1000, "comp": "낮음", "bid": 700},  # 700원→239회
    "에어컨바람안나옴":     {"ms": 800,  "comp": "낮음", "bid": 500},  # 500원→58회
    "에어컨물":            {"ms": 800,  "comp": "낮음", "bid": 500},  # 500원→95회
    "창문형에어컨수리":     {"ms": 500,  "comp": "낮음", "bid": 300},  # 300원→63회
    "에어컨시원하지않음":   {"ms": 500,  "comp": "낮음", "bid": 300},  # 300원→74회
    "에어컨전원안켜짐":     {"ms": 500,  "comp": "낮음", "bid": 300},  # 300원→42회
    "실외기고장":          {"ms": 1000, "comp": "낮음", "bid": 500},  # 500원→105회
}
