...
KW_MAX_BID = {
    ...
    "에어컨전기세":         5000,
    "에어컨냉매가스":       3000,
    "에어컨얼음":           3000,   # 상향 (2026-06-25, 노출 부족)
    "에어컨성에":           3000,   # 상향 (700→3000)
    "대우에어컨수리":       3000,   # 상향 (700→3000)
    "위니아에어컨수리":      700,
    "에어컨실외기안돌아감": 2000,
    "에어컨소음":           3000,
    "실외기소음":           3000,
    ...
    "에어컨고장":           5000,
    "에어컨가스충전비용":   5000,
    "에어컨바람안나옴":     3000,   # 상향 (1000→3000)
    "에어컨물":             3000,
    "창문형에어컨수리":     3000,   # 상향 (500→3000)
    "에어컨시원하지않음":   3000,   # 상향 (500→3000)
    "에어컨전원안켜짐":     3000,   # 상향 (500→3000)
    "실외기고장":           3000,
    "시스템에어컨누설수리": 15000,  # 상향 (3000→15000, 노출0)
    "시스템에어컨수리":     15000,  # 상향 (3000→15000, 노출0)
    "시스템에어컨누수":     15000,  # 상향 (2000→15000, 노출0)
    "에어컨매립배관":       10000,  # 상향 (1500→10000, 노출0)
    "에어컨매립배관수리":   10000,  # 상향 (1500→10000, 노출0)
}
...
INIT_BIDS = {
    ...
    "LG에어컨수리":        2000,
    "에어컨점검":          2000,
    "에어컨매립배관":      3000,   # 상향 (700→3000, 노출0 대응)
    "에어컨매립배관수리":  3000,   # 상향 (1500→3000, 노출0 대응)
    "에어컨매립배관교체":  3000,
    "에어컨물떨어짐":       700,
    "에어컨냉매":           700,
    "에어컨실외기소음":     700,
    ...
    "에어컨냉매가스":      1500,
    "에어컨얼음":          1000,   # 상향
    "에어컨성에":          1000,   # 상향 (300→1000)
    "대우에어컨수리":      1000,   # 상향 (300→1000)
    "위니아에어컨수리":     300,
    "에어컨실외기안돌아감": 500,
    "에어컨소음":          1000,
    "실외기소음":           700,
    ...
    "에어컨고장":          1500,
    "에어컨가스충전비용":  1000,
    "에어컨바람안나옴":     1000,   # 상향 (500→1000)
    "에어컨물":            1500,
    "창문형에어컨수리":    1000,   # 상향 (300→1000)
    "에어컨시원하지않음":  1000,   # 상향 (300→1000)
    "에어컨전원안켜짐":    1000,   # 상향 (300→1000)
    "실외기고장":          2000,
    "시스템에어컨누설수리": 5000,  # 상향 (1500→5000, 노출0 대응)
    "시스템에어컨수리":     5000,  # 상향 (1500→5000, 노출0 대응)
    "시스템에어컨누수":     5000,  # 상향 (1000→5000, 노출0 대응)
}
